Cufon.replace('.top-block a.logo', {
    ...
    color: "-linear-gradient('#79c1ff', '#4978c8')",
...
$(document).ready(function () {
    ...
    $(".bg-e-button").delay(2500).animate({
        opacity: 1
    }, 150);
    $(".open").click(function () {
        $(".center-block").fadeIn(1000);
        $(".bottom-block h5").delay(700).fadeIn(1000);
        $(".container").animate({
            marginTop: "-220px"
        }, {
            duration: 3000,
        ...
        $(".scanner-line").delay(1000).animate({
            ...
            complete: function () {
                ...
                setTimeout(function () {
                    ...
                    $(".scanner").hide();
                    $(".main").show();
                    $(".load").fadeTo(50, 0.3).fadeIn(500);
                    $(".shut-left,.shut-right").delay(2000).animate({
                        width: "0px"
                    }, {
                        duration: 2500,
                        specialEasing: {
    ...
    $('a.skill-start').click(function () {
        setTimeout(function () {
            $(".pr1").progression({
                Current: 100,
                Easing: 'easeOutExpo',
                aBackgroundImg: 'https://raw.githubusercontent.com/plucyvrz/defacepage/master/images/progress.png'
            });
            $(".pr2").progression({
                Current: 75,
                Easing: 'easeOutExpo',
    ...
    var options = {
        ...
        success: function () {
            ...
            $(".mess").show().html('<h4>Thanks !</h4><h4>Your message has been sent.</h4>');
            $('.mess').delay(3000).fadeOut(function () {
                $('#contactus').clearForm();
                $('.contactusb form').delay(2500).show()
            })
        },
        url: './php/contact.php'
    };
